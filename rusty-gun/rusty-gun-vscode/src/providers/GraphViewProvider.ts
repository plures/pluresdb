...
export class GraphViewProvider
  implements vscode.TreeDataProvider<GraphViewItem> {
  private _onDidChangeTreeData: vscode.EventEmitter<
    GraphViewItem | undefined | null | void
  > = new vscode.EventEmitter<GraphViewItem | undefined | null | void>();
  ...
  toggleLayout(): void {
    this.currentLayout = this.currentLayout === "cose-bilkent"
      ? "dagre"
      : "cose-bilkent";
    vscode.commands.executeCommand("rusty-gun.refreshExplorer");
  }
