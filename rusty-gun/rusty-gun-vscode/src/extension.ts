...
export async function activate(context: vscode.ExtensionContext) {
    ...
    // Initialize webview
    const dashboardWebview = new DashboardWebview(context.extensionUri, rustyGunClient);
    ...
    context.subscriptions.push(
        vscode.window.registerWebviewViewProvider('rusty-gun.dashboard', dashboardWebview)
    );
