...
await db.put("user:alice", { name: "Alice", age: 30, city: "London", vector: undefined });
...
console.log("Semantic search results:", results.map((n) => ({ id: n.id, text: (n.data as any).text })));
