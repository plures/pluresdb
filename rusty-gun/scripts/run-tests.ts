...
async function main() {
  ...
  const testSuites: TestSuite[] = [
    {
      name: "Unit Tests",
      command: "test -A --parallel src/tests/unit/",
      description: "Core functionality tests (CRUD, subscriptions, vector search)",
      timeout: 30000
    },
    {
      name: "Integration Tests", 
      command: "test -A --parallel src/tests/integration/",
      description: "Mesh networking and API server tests",
      timeout: 60000
    },
    {
      name: "Performance Tests",
      command: "test -A --parallel src/tests/performance/",
      description: "Load testing and performance validation",
      timeout: 120000
    },
    {
      name: "Security Tests",
      command: "test -A --parallel src/tests/security/",
