  ...
  <div class="rules-layout">
    ...
    <div class="rules-sidebar">
      <div class="sidebar-header">
        ...
        <button on:click={() => (showNewRule = true)} class="primary"> New Rule </button>
      </div>
      ...
      {#if selectedRule}
        <div class="builder-header">
          ...
          <div class="builder-actions">
            ...
            <button on:click={executeRule} class="primary"> Execute Rule </button>
          </div>
        </div>
          ...
          <div class="conditions-section">
            ...
            <div class="add-condition">
              ...
              <div class="condition-form">
                ...
                <input type="text" bind:value={newCondition.value} placeholder="Value..." />
          ...
          <div class="actions-section">
              ...
              {#each selectedRule.actions as action, index}
                <div class="action-item">
                  <div class="action-content">
                    ...
                    <input type="text" bind:value={action.field} placeholder="Field name..." />
                    <input type="text" bind:value={action.value} placeholder="Value..." />
                  </div>
            ...
            <div class="add-action">
              ...
              <div class="action-form">
                ...
                <input type="text" bind:value={newAction.field} placeholder="Field name..." />
                <input type="text" bind:value={newAction.value} placeholder="Value..." />
                <button on:click={addAction} class="small"> Add Action </button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="dialog-overlay">
      <div class="dialog">
        ...
        <div class="dialog-actions">
          <button on:click={createRule} disabled={!newRuleName.trim()}> Create </button>
          <button on:click={() => (showNewRule = false)} class="secondary"> Cancel </button>
        </div>
      </div>
    </div>
  {/if}
  ...
  {#if showRuleTester}
    <div class="dialog-overlay">
      <div class="dialog large">
        ...
        <div class="dialog-actions">
          <button on:click={() => (showRuleTester = false)} class="secondary"> Close </button>
        </div>
      </div>
    </div>
  {/if}
