...
<section aria-labelledby="graph-heading">
  ...
  <div class="graph-controls">
    ...
    <div class="control-group">
      ...
      />
      <button on:click={searchNodes} disabled={!searchQuery.trim()}> Search </button>
    </div>
  ...
  <div class="graph-actions">
    <button on:click={clearSelection} class="secondary"> Clear Selection </button>
    <button on:click={fitToScreen} class="secondary"> Fit to Screen </button>
    <button on:click={centerGraph} class="secondary"> Center </button>
    <button on:click={exportGraph} class="secondary"> Export PNG </button>
  </div>
  ...
  <div class="graph-info">
    <p>
      ...
      <strong>Total:</strong>
      {cy ? cy.nodes().length : 0} nodes |
      <strong>Edges:</strong>
      {cy ? cy.edges().length : 0} edges
    </p>
  </div>
</section>
