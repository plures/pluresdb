  ...
  <div class="mesh-layout">
    ...
    <div class="mesh-controls">
      <div class="control-group">
        <button on:click={loadMeshData} class="secondary"> Refresh </button>
          ...
          >
            ...
            <div class="peer-details">
              ...
              <div class="peer-messages">
                <span
                  >Messages: {peer.messageRate.incoming}/s in, {peer.messageRate.outgoing}/s out</span
                >
              </div>
        ...
        <div class="details-grid">
          ...
          <div class="detail-item">
            ...
            <span style="color: {getStatusColor(selectedPeer.status)}">
              {getStatusIcon(selectedPeer.status)}
              {selectedPeer.status}
            </span>
          </div>
          <div class="detail-item">
          ...
          <div class="detail-item">
            <span class="detail-label">Messages In</span>
            <span>{selectedPeer.messageRate.incoming}/s</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">Messages Out</span>
...
<style>
  ...
  .capabilities-section .detail-label {
    display: block;
    margin-bottom: 0.5rem;
    font-weight: 600;
  }
