  ...
  function getQuickActions(node: any) {
    ...
    if (node.data.tags) {
      actions.push({
        label: "View tags",
        action: () => {
          tagFilter = Array.isArray(node.data.tags) ? node.data.tags.join(" ") : node.data.tags;
        },
      });
    }
  ...
  <div class="search-controls">
    <div class="filters-section">
      ...
      <div class="filter-group">
        ...
        <input id="tag-filter" type="text" bind:value={tagFilter} placeholder="Filter by tags..." />
      </div>
    ...
    <div class="actions-section">
      <button on:click={clearFilters} class="secondary"> Clear Filters </button>
      <button on:click={() => (showSaveDialog = true)} class="secondary"> Save Search </button>
    ...
    <div class="save-dialog">
      <div class="dialog-content">
        ...
        <div class="dialog-actions">
          <button on:click={saveSearch} disabled={!searchName.trim()}> Save </button>
        ...
        {#each savedSearches as search}
          <div class="saved-item">
            ...
            <div class="saved-actions">
              <button on:click={() => applySavedSearch(search)} class="small"> Apply </button>
          ...
          >
            ...
            <div class="quick-actions">
              {#each getQuickActions(node) as action}
                <button class="quick-action" on:click|stopPropagation={() => action.action()}>
                  {action.label}
                </button>
              {/each}
            </div>
      ...
      {#if selectedNode}
        <div class="result-detail">
          <div class="detail-header">
            ...
            <button on:click={() => (selectedNode = null)} class="close-button"> × </button>
          </div>
