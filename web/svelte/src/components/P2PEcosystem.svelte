<script lang="ts">
  ...
  function getStatusColor(status: string): string {
    switch (status) {
      ...
      case 'syncing': return 'var(--warning-color)'
      case 'active': return 'var(--success-color)'
      case 'inactive': return 'var(--muted-color)'
      case 'updating': return 'var(--warning-color)'
      ...
      {#if activeTab === 'network'}
        <div class="network-section">
          <div class="section-header">
            <h4>P2P Network</h4>
            <button on:click={() => showNodeDialog = true} class="primary">
              Add Node
            </button>
          </div>
          ...
          <div class="network-stats">
            <div class="stat-card">
              ...
              <div class="stat-value">{networkNodes.filter(n => n.status === 'online').length}</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">Total Bandwidth</div>
              <div class="stat-value">{formatBytes(networkNodes.reduce((sum, n) => sum + n.bandwidth.incoming + n.bandwidth.outgoing, 0))}/s</div>
            </div>
            <div class="stat-card">
              <div class="stat-title">Data Shared</div>
              <div class="stat-value">{formatBytes(networkNodes.reduce((sum, n) => sum + n.dataShared, 0))}</div>
            </div>
          </div>
              ...
              >
                ...
                <div class="node-details">
                  <div class="node-metrics">
                    ...
                    <span>Bandwidth: {formatBytes(node.bandwidth.incoming)}/s in, {formatBytes(node.bandwidth.outgoing)}/s out</span>
                ...
                <div class="node-actions">
                  {#if node.status === 'online'}
                    <button on:click|stopPropagation={() => disconnectFromNode(node.id)} class="small error">
                      Disconnect
                    </button>
                  {:else}
                    <button on:click|stopPropagation={() => connectToNode(node.address)} class="small success">
                      Connect
                    </button>
                  {/if}
                </div>
        ...
        <div class="security-section">
          ...
          <div class="security-grid">
            <div class="security-item">
              ...
              <select bind:value={securityConfig.encryption}>
            ...
            <div class="security-item">
              ...
              <select bind:value={securityConfig.keyExchange}>
            ...
            <div class="security-item">
              ...
              <select bind:value={securityConfig.authentication}>
            ...
            <div class="security-item">
              ...
              <select bind:value={securityConfig.dataIntegrity}>
      ...
      {:else if activeTab === 'sync'}
        <div class="sync-section">
          ...
          <div class="sync-controls">
            <button on:click={startSync} disabled={syncStatus.syncMode === 'realtime'} class="primary">
              Start Sync
            </button>
            <button on:click={stopSync} disabled={syncStatus.syncMode === 'manual'} class="secondary">
              Stop Sync
            </button>
            <button on:click={resolveConflicts} disabled={syncStatus.pendingChanges === 0} class="secondary">
              Resolve Conflicts
            </button>
          </div>
      ...
      {:else if activeTab === 'offline'}
        <div class="offline-section">
          ...
          <div class="offline-actions">
            <button on:click={enableOfflineMode} class="primary">
              Enable Offline Mode
            </button>
            <button on:click={disableOfflineMode} class="secondary">
      ...
      {:else if activeTab === 'ecosystem'}
        <div class="ecosystem-section">
          <div class="section-header">
            ...
            <button on:click={() => addEcosystemApp({})} class="primary">
              Add App
            </button>
          </div>
