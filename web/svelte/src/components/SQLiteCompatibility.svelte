<script lang="ts">
  ...
  let dark = false;
  let activeTab: "sql-query" | "transactions" | "schema" | "migration" | "compatibility" =
    "sql-query";
      ...
      {#if activeTab === "sql-query"}
        <div class="sql-query-section">
          ...
          <div class="query-editor">
            <textarea bind:value={sqlQuery} placeholder="Enter your SQL query here..." rows="8"
            ></textarea>
            <div class="query-actions">
              ...
              <button on:click={() => (sqlQuery = "")} class="secondary"> Clear </button>
            </div>
          </div>
          ...
          <div class="section-header">
            ...
            <div class="transaction-controls">
              ...
              <button
                on:click={() =>
                  startTransaction(
                    document.getElementById("isolation-level")?.value || "read_committed",
                  )}
                class="primary"
              >
                Start Transaction
              ...
              <div class="transaction-item">
                ...
                {#if transaction.status === "active"}
                  <div class="transaction-actions">
                    <button
                      on:click={() => commitTransaction(transaction.id)}
                      class="small success"
                    >
                      Commit
                    </button>
                    <button
                      on:click={() => rollbackTransaction(transaction.id)}
                      class="small error"
                    >
                      Rollback
                    </button>
              ...
              <div class="migration-item">
                <div class="migration-header">
                  ...
                  <div
                    ...
                    style="color: {getStatusColor(migration.applied ? 'applied' : 'pending')}"
                  >
                    {getStatusIcon(migration.applied ? "applied" : "pending")}
      ...
      {:else if activeTab === "compatibility"}
        <div class="compatibility-section">
            ...
            {#each Object.entries(compatibilityFeatures) as [feature, supported]}
              <div class="compatibility-item">
                ...
                <div
                  ...
                  style="color: {supported ? 'var(--success-color)' : 'var(--error-color)'}"
                >
          ...
          <div class="compatibility-info">
            ...
            <p>
              PluresDB provides comprehensive SQLite compatibility with support for most standard
              SQL features, transactions, indexes, and constraints. Perfect for drop-in replacement
