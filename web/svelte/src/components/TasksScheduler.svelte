  ...
  <div class="tasks-layout">
    ...
    <div class="tasks-sidebar">
      <div class="sidebar-header">
        ...
        <button on:click={() => showNewTask = true} class="primary">
          New Task
        </button>
      </div>
      ...
      {#if selectedTask}
        <div class="details-header">
          ...
          <div class="details-actions">
            ...
            <button on:click={() => runTask(selectedTask)} disabled={selectedTask.status === 'running'} class="primary">
        ...
        <div class="task-info">
          <div class="info-grid">
            ...
            <div class="info-item">
              <label>Status</label>
              <span class="status-badge" class:running={selectedTask.status === 'running'} class:success={selectedTask.status === 'success'} class:error={selectedTask.status === 'error'}>
                {selectedTask.status}
              </span>
            </div>
            <div class="info-item">
          ...
          <div class="task-logs">
            ...
            <div class="logs-list">
              {#each selectedTask.logs as log}
                <div class="log-item" class:info={log.level === 'info'} class:warn={log.level === 'warn'} class:error={log.level === 'error'}>
    ...
    <div class="dialog-overlay">
      <div class="dialog">
        ...
        <div class="form-group">
          ...
          <input 
            type="text" 
            bind:value={newTaskSchedule} 
            placeholder="Custom cron expression..."
          />
        </div>
        <div class="dialog-actions">
          <button on:click={createTask} disabled={!newTaskName.trim()}>
            Create
          </button>
          <button on:click={() => showNewTask = false} class="secondary">
            Cancel
          </button>
        </div>
      </div>
