          ...
          <div class="docker-status">
            <div class="status-card">
              <div class="status-header">
                ...
                <span
                  class="status-value"
                  style="color: {getStatusColor(dockerStatus.imageBuilt ? 'running' : 'stopped')}"
                >
          ...
          <div class="docker-actions">
            ...
            {#if dockerStatus.imageBuilt}
              {#if dockerStatus.containerRunning}
                <button on:click={stopDockerContainer} class="secondary"> Stop Container </button>
              {:else}
                <button on:click={runDockerContainer} class="secondary"> Run Container </button>
              {/if}
            {/if}
          </div>
        ...
        <div class="windows-section">
          ...
          <div class="windows-status">
            <div class="status-card">
              <div class="status-header">
                ...
                <span
                  class="status-value"
                  style="color: {getStatusColor(windowsStatus.msiBuilt ? 'running' : 'stopped')}"
                >
            ...
            <div class="status-card">
              <div class="status-header">
                ...
                <span
                  class="status-value"
                  style="color: {getStatusColor(windowsStatus.wingetReady ? 'running' : 'stopped')}"
                >
          ...
          <div class="windows-actions">
            ...
            {#if windowsStatus.msiBuilt}
              <button class="secondary"> Download MSI </button>
            {/if}
            {#if windowsStatus.wingetReady}
              <button class="secondary"> Publish to Winget </button>
            {/if}
          </div>
        </div>
      {:else if activeTab === "updates"}
        <div class="updates-section">
          ...
          <div class="update-status">
            ...
            <div class="status-card">
              <div class="status-header">
                ...
                <span
                  class="status-value"
                  style="color: {updateStatus.updateAvailable
                    ? 'var(--warning-color)'
                    : 'var(--success-color)'}"
                >
          ...
          <div class="update-actions">
            <button on:click={checkForUpdates} class="primary"> Check for Updates </button>
            {#if updateStatus.updateAvailable}
              <button on:click={installUpdate} class="secondary"> Install Update </button>
            {/if}
          </div>
      ...
      {:else if activeTab === "deploy"}
        <div class="deploy-section">
          ...
          <div class="deploy-status">
            ...
            <div class="status-card">
              <div class="status-header">
                ...
                <span
                  class="status-value"
                  style="color: {getStatusColor(deploymentStatus.healthCheck)}"
                >
                  {getStatusIcon(deploymentStatus.healthCheck)}
            ...
            <div class="status-card">
              <div class="status-header">
                ...
                <span class="status-value">
                  {deploymentStatus.lastDeploy
                    ? formatTimestamp(deploymentStatus.lastDeploy)
                    : "Never"}
                </span>
              </div>
            </div>
          ...
          <div class="deploy-actions">
            <button on:click={deployToProduction} class="primary"> Deploy to Production </button>
            <button class="secondary"> Deploy to Staging </button>
            <button class="secondary"> Rollback </button>
          </div>
        </div>
      {/if}
    </div>
