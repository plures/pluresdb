<script lang="ts">
  ...
  let availableActions = ["read", "write", "delete", "create", "update", "execute", "manage"];
...
<section aria-labelledby="security-panel-heading">
    ...
    <div class="security-content">
      {#if activeTab === "users"}
        <div class="users-section">
          <div class="section-header">
            <h4>Users</h4>
            <button on:click={() => (showUserDialog = true)} class="primary"> Add User </button>
          </div>
            ...
            {#each users as user}
              ...
              >
                ...
                <div class="user-details">
                  <span
                    >Last login: {user.lastLogin ? formatTimestamp(user.lastLogin) : "Never"}</span
                  >
      ...
      {:else if activeTab === "roles"}
        <div class="roles-section">
          <div class="section-header">
            <h4>Roles</h4>
            <button on:click={() => (showRoleDialog = true)} class="primary"> Add Role </button>
          </div>
      ...
      {:else if activeTab === "policies"}
        <div class="policies-section">
          <div class="section-header">
            <h4>Policies</h4>
            <button on:click={() => (showPolicyDialog = true)} class="primary"> Add Policy </button>
          </div>
      ...
      {:else if activeTab === "tokens"}
        <div class="tokens-section">
          <div class="section-header">
            <h4>API Tokens</h4>
            <button on:click={() => (showTokenDialog = true)} class="primary"> Add Token </button>
          </div>
            ...
            {#each tokens as token}
              ...
              >
                ...
                <div class="token-details">
                  ...
                  <span
                    >Last used: {token.lastUsed ? formatTimestamp(token.lastUsed) : "Never"}</span
                  >
                </div>
        ...
        <div class="settings-section">
          ...
          <div class="settings-grid">
            <div class="setting-item">
              ...
              <input id="session-timeout" type="number" value="3600" min="300" max="86400" />
              <span>seconds</span>
            </div>
            <div class="setting-item">
            ...
            <div class="setting-item">
              ...
              <input id="two-factor-auth" type="checkbox" />
            </div>
            <div class="setting-item">
              <label for="api-rate-limit">API Rate Limiting</label>
              <input id="api-rate-limit" type="number" value="1000" min="100" max="10000" />
    ...
    <div class="dialog-overlay">
      <div class="dialog">
        ...
        <div class="dialog-actions">
          ...
          <button on:click={() => (showUserDialog = false)} class="secondary"> Cancel </button>
        </div>
      </div>
    </div>
  {/if}
  ...
  {#if showRoleDialog}
    <div class="dialog-overlay">
      <div class="dialog">
        <h4>Add Role</h4>
        <input type="text" bind:value={newRole.name} placeholder="Role name..." />
        <textarea bind:value={newRole.description} placeholder="Description..." rows="3"></textarea>
        <div class="permissions-grid">
          {#each availablePermissions as permission}
            <label>
              <input type="checkbox" bind:group={newRole.permissions} value={permission} />
              {permission}
            </label>
          {/each}
        </div>
        <div class="dialog-actions">
          <button on:click={createRole} disabled={!newRole.name.trim()}> Create </button>
          <button on:click={() => (showRoleDialog = false)} class="secondary"> Cancel </button>
        </div>
      </div>
    </div>
  {/if}
  ...
  {#if showPolicyDialog}
    <div class="dialog-overlay">
      <div class="dialog">
        <h4>Add Policy</h4>
        <input type="text" bind:value={newPolicy.name} placeholder="Policy name..." />
        <textarea bind:value={newPolicy.description} placeholder="Description..." rows="3"
        ></textarea>
        ...
        <div class="actions-grid">
          {#each availableActions as action}
            <label>
              <input type="checkbox" bind:group={newPolicy.actions} value={action} />
              {action}
            </label>
          {/each}
        </div>
        <div class="dialog-actions">
          <button
            ...
            disabled={!newPolicy.name.trim() || !newPolicy.resource.trim()}
          >
            Create
          </button>
          <button on:click={() => (showPolicyDialog = false)} class="secondary"> Cancel </button>
        </div>
      </div>
    </div>
  {/if}
  ...
  {#if showTokenDialog}
    <div class="dialog-overlay">
      <div class="dialog">
        <h4>Add Token</h4>
        <input type="text" bind:value={newToken.name} placeholder="Token name..." />
        <input type="number" bind:value={newToken.expiresIn} min="1" max="365" />
        <span>days</span>
        <div class="permissions-grid">
          {#each availablePermissions as permission}
            <label>
              <input type="checkbox" bind:group={newToken.permissions} value={permission} />
              {permission}
            </label>
          {/each}
        </div>
        <div class="dialog-actions">
          <button on:click={createToken} disabled={!newToken.name.trim()}> Create </button>
          <button on:click={() => (showTokenDialog = false)} class="secondary"> Cancel </button>
        </div>
      </div>
    </div>
  {/if}
